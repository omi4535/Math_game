...
public class addition_act extends AppCompatActivity {
    ...
    public void onBackPressed() {
        game_reset();
        Intent after_gameover = new Intent(addition_act.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent after_gameover = new Intent(addition_act.this, game_over.class);
            ...
            public void onClick(View view) {
                ...
                if (!ans.getText().toString().trim().isEmpty()) {
                    ...
                    if (helper_class.help_check(n1 + n2, ur_ans)) {
                        ...
                        MediaPlayer medias = MediaPlayer.create(addition_act.this, R.raw.success);
                        medias.start();
                        v.setBackground(ContextCompat.getDrawable(getApplicationContext(), back_images[0]));

                    } else {
                        // if wrong then decrease in live by one
                        MediaPlayer median = MediaPlayer.create(addition_act.this, R.raw.negative);
                        median.start();
                        act_lives -= 1;
                        checked = true;
                    ...
                    Toast.makeText(addition_act.this, "enter your answer", Toast.LENGTH_SHORT).show();
                }
            }
        });
